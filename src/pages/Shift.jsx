...
const Shift = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const newShift = {
      ...
      shiftType,
      differentialRate,
      timeRange: `${convertTo12HourFormat(startTime)} - ${convertTo12HourFormat(endTime)}`,
    };
    ...
    try {
      if (editIndex !== null) {
        ...
        const response = await axios.post("http://localhost:8059/shifts", newShift);
          ...
          <tbody className="text-xs sm:text-sm">
            {filteredShifts.length === 0 ? (
              ...
              filteredShifts.map((shift, index) => (
                ...
                >
                  <td className="border border-gray-300 p-2">{shift.employeeName}</td>
                  <td className="border border-gray-300 p-2">{shift.employeePosition}</td>
                  <td className="border border-gray-300 p-2">{shift.shiftType}</td>
                  <td className="border border-gray-300 p-2">{shift.timeRange}</td>
